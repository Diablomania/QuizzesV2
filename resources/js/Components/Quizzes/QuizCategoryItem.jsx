        ...
        <div
            ...
            <a onClick={() => getQuiz(quiz.id)} href="#">
                ...
                <div className="p-5 flex-grow">
                    <h5 className="capitalize mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white line-clamp-1">{quiz.name}</h5>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 line-clamp-3 h-[4.5rem]">{quiz.description ?? ""}</p>
                </div>
            </a>
        </div>
    );
