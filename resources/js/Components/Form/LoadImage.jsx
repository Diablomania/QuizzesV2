...
export default function LoadImage({fileSet, questionIndex = null, answerIndex = null}) {
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            fileSet(file, questionIndex, answerIndex);
    ...
    return (
        <div className="mb-4">
            <div
                className={`w-full py-9 rounded-2xl border gap-3 grid ${
                    isDragging ? "bg-gray-800 border-indigo-500" : "bg-gray-900 border-gray-300"
                }`}
            ...
            >
                ...
                {filePreview && (
                    <div className="mt-4 text-center">
                        <h5 className="text-gray-400 text-sm mb-2">{t("fileForm.preview")}</h5>
                        <img
                            src={filePreview}
                            alt={t("fileForm.imgAlt")}
                            className="mx-auto max-h-40 rounded-lg border border-gray-300"
                        />
